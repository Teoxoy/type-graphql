...
function createHandlerResolver(resolverMetadata) {
    const { validate: globalValidate, validateOrRejectFn, authChecker, authMode, pubSub, globalMiddlewares, container, } = build_context_1.BuildContext;
    ...
    return (root, args, context, info) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return helpers_1.applyMiddlewares(container, resolverData, middlewares, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const params = yield helpers_1.getParams(resolverMetadata.params, resolverData, globalValidate, validateOrRejectFn, pubSub);
    ...
    return (root, args, context, info) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return helpers_1.applyMiddlewares(container, resolverData, middlewares, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof handlerOrGetterValue === "function") {
                const params = yield helpers_1.getParams(fieldResolverMetadata.params, resolverData, globalValidate, validateOrRejectFn, pubSub);
