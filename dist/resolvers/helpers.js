...
function getParams(params, resolverData, globalValidate, validateOrRejectFn, pubSub) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return Promise.all(params
            ...
            switch (paramInfo.kind) {
                case "args":
                    return yield validate_arg_1.validateArg(types_1.convertToType(paramInfo.getType(), resolverData.args), globalValidate, validateOrRejectFn, paramInfo.validate);
                case "arg":
                    return yield validate_arg_1.validateArg(types_1.convertToType(paramInfo.getType(), resolverData.args[paramInfo.name]), globalValidate, validateOrRejectFn, paramInfo.validate);
                case "context":
