...
export declare function getParams(params: ParamMetadata[], resolverData: ResolverData<any>, globalValidate: boolean | ValidatorOptions, validateOrRejectFn: (object: Object, validatorOptions?: ValidatorOptions) => Promise<void>, pubSub: PubSubEngine): Promise<any[]>;
